# Using AWS CDK to create a Lambda, CWEvent and DynamoDb in Python 

This is a very simple example of using AWS CDK to define in Python 
([Python >= 3.7.1](https://docs.aws.amazon.com/cdk/latest/guide/getting_started.html)) a Lambda function (scheduled
with CloudWatch Event) that writes a random string to a DynamoDb table.
